...
using System.Text;
using ASI.Basecode.Data.ViewModels.Common;
...
namespace Basecode.WebApp.Utilities
{
    public class GetAuthResponse
    {
        ...
        /// <returns></returns>
        public static LoginViewModel Execute(ClaimsIdentity identity, AsiBasecodeDBContext db, IdentityUser userName, RefreshToken refreshToken = null)
        {
